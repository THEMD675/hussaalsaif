...
export const metadata: Metadata = {
  ...
  description: "Hussa AlSaif's media kit: 530K+ combined reach, 13+ brand partners including Sephora, Estée Lauder, MAC, Fendi. Audience demographics, content formats, and partnership tiers.",
